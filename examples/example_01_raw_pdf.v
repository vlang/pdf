...
fn main(){
    ...
    mut content := pdf.Obj{id:doc.get_new_id(), is_stream: true, compress: true}
    ...
    doc.add_page_obj(page, content)

    // render the PDF
    txt := doc.render()

    // write it to a file
    os.write_file_array('example01.pdf', txt.buf)
}